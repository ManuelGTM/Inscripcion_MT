...
{
    public partial class FConsultaTutor : Form
    {

        public int visuplidor = 0, vtieneparametro = 0, indice = 1;
        public string valorparametro = "", mensaje = "";

        CNTutor objSuplidor = new CNTutor();
        private void FConsultaTutor_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        {
            valorparametro = tbBuscar.Text.Trim();
            if (objSuplidor.ObtenerTutor(valorparametro) != null)
            {
                DGVDatos.DataSource = objSuplidor.ObtenerTutor(valorparametro);
                ...
                DGVDatos.Refresh();
            LCantTutor.Text = Convert.ToString(DGVDatos.RowCount);
