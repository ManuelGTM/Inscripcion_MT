...
namespace CapaNegocio
{
    ...
    {
        public static string InsertarEstudiante(string Nombre, string Apellido, int IdTutor,string Sexo, string FechaNacimiento, string Direccion, string Estado)
        {
        ...
        public static string ActualizarEstudiante(int IdEstudiante, string Nombre, string Apellido, int IdTutor,string Sexo, string FechaNacimiento, string Direccion, string Estado)
        {
            CDEstudiante objEstudiante = new CDEstudiante();
